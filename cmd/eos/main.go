...
func printUsage() {
	...
	fmt.Println("calibrate-sparse-routing sweeps block-anchor sparse routing budgets on synthetic tensors and writes router recall, output delta, and score-work calibration artifacts.")
