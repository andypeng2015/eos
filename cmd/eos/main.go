...
func printUsage() {
	...
	fmt.Println("calibrate-sparse-routing sweeps sparse routing policy budgets on synthetic tensors and writes router recall, output delta, and score-work calibration artifacts.")
