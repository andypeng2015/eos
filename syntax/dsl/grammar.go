// Package dsl holds the Eos tree-sitter grammar definition. It is used only to
// regenerate the pre-generated parse table (syntax/grammar.bin) via
// cmd/eos-grammar; it pulls in grammargen (and the grammars registry), so it is
// kept out of the consumable syntax package, which loads the blob directly.
package dsl
