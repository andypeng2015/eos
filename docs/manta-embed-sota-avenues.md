...
Current capped LongEmbed evidence for the same s40 line is diagnostic and not a product-quality claim. On QMSum capped `real-doc20`, best Eos is token-span q4 nDCG@10 `0.560693`, behind Qwen3 q4 `0.848162` and mxbai q4 `0.828480`. On 2WikiMQA capped `real-doc20`, best Eos is fusion RRF `0.745700`, behind Qwen3 q4 `1.000000` and mxbai q4 `0.981546`. Preserve `quality_claim=false`, capped-slice caveats, and external child-count/storage caveats when using these rows.
