...
1. Launch the next guarded candidate from `runs/eos-shortset-agreement-teacher-prep-v1-20260621T000000Z/shortset.qwen3-mxbai.agreement-filtered.train-hard-negatives.jsonl`; local source/LR/grouped reshuffling around the deep-mined file is now exhausted for balanced promotion.
