...
| Corrected q2-341 packed time-series smoke | Local flat CorkScrewDB API plus packed planner | Original corrected wrapper run `runs/eos-corkscrewdb-timeseries-window-q2-341-variants20-packed-minimal-corrected-20260616T000000Z/` generated the `100` parent, `34,100` child-window inputs and packed planner evidence. Compact snapshot v5 child-vector smoke rerun `runs/eos-corkscrewdb-q2-341-compact-snapshot-v5-20260616T000000Z/`, against CorkScrewDB commit `c208f9b50d29f9fdf19771c4b093332c7c8fd0b4`, measured the persisted DB directory on those inputs. q2 `128d` packed payload used `quantized_vector_bytes=36`, `quantized_child_bytes=1,227,600`, vector payload multiple `0.9990234375x`, packed planner bytes `12,308` with overhead `32`, planner multiple `0.999025974025974x`, persisted DB bytes `1,237,808`, DB directory multiple `1.0073307291666667x`, nDCG@10 `0.449394`, recall@100 `1.000000`, p95 `1.521388ms`. | With CorkScrewDB compact snapshot v5 ordinal encoding, the persisted DB directory is approximately one dense parent-vector budget for this strict shape. This applies only to quantized-only packed children with `packed_metadata_mode=none` and `packed_child_id_mode=ordinal`; without that compact snapshot path, or for richer child records, keep DB directory cost separate. Synthetic text-rendered windows; local flat API only. |
