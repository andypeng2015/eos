...
Predecessor nf005 packed-parent local flat API evidence is attached in `.tiller/scratch/codex/eos-nf005-current-default-corkscrewdb-api-smoke-v1-report.md`, with run `runs/eos-nf005-current-default-corkscrewdb-budget-quality-packed-q4q8-20260617T142823Z/` and vector cache `runs/eos-vector-caches/eos-nf005-current-default-scifact-child-w128-o32-128d/`. The q4 release-gate row used `packed_parent_multivectors`, `packed_metadata_mode=none`, and ordinal child IDs, recording nDCG@10 `0.451122`, recall@100 `0.755222`, DB directory multiple `0.020372x`, vector payload multiple `0.013312x`, p95 `142.971679ms`, planner fit `180`, `target_child_fit=true`, and target storage multiple `0.554545x`. The q8 row is diagnostic only: nDCG@10 `0.472867`, recall@100 `0.780222`, DB directory multiple `0.032901x`, p95 `22.988553ms`, planner fit `93`, and `target_child_fit=false`. This historical direct quantized packed-parent API evidence stays separate from the q4/fp16/rerank-overfetch=200 serving proxy evidence, is not s40 API proof, and the q4 p95 is run evidence rather than a service SLO.
