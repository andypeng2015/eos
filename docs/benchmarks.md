...
Current s40 official capped LongEmbed comparisons remain diagnostic and non-promotable. On `qmsum` capped `real-doc20`, the best Eos row is token-span q4 nDCG@10 `0.560693`, versus Qwen3 q4 `0.848162` and mxbai q4 `0.828480`. On `2wikimqa` capped `real-doc20`, the best Eos row is fusion RRF `0.745700`, versus Qwen3 q4 `1.000000` and mxbai q4 `0.981546`. Preserve `quality_claim=false`, the capped-slice caveat, and the external child-count/storage caveat when citing these rows.
