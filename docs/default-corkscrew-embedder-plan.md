...
Current-default hybrid policy candidate status: the durable default asset `assets/corkscrewdb-default-embedder/corkscrewdb-default-embedder.mll`, SHA256 `f494915a0d78b24205d5018bb701bf40cabbedee4bc8b96b6a1920b19131da5a`, has command-level and full uncapped CorkScrewDB `SearchMulti` evidence in `runs/eos-s40-current-default-hybrid-policy-v1-20260621T103500Z/`. Command-level `eval-retrieval-hybrid --method minmax_blend --alpha 0.5 --top-k 100` passed SciFact `0.717644867485 / 0.932888888889`, NFCorpus `0.311170830256 / 0.290149896585`, and FiQA `0.219415915378 / 0.500671683426` for hybrid nDCG@10 / recall@100, with positive deltas over s40 dense on all six checks. Full uncapped BM25-dot `SearchMulti` smokes passed with SciFact `0.724378172602 / 0.932888888889`, NFCorpus `0.315090347196 / 0.293990495284`, and FiQA `0.223742712175 / 0.504002444743`, all `overall_pass=true`. Promotion boundary: this is an optional local lexical+dense retrieval-policy candidate over the current default dense channel; it is not dense model promotion, does not change the default asset or alias, and does not prove remote mode, HNSW, federation, or hosted-model parity.
